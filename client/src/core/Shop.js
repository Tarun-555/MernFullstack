...
const Shop = () => {
  ...
  return (
    ...
    >
      <div className="my-4">
        <div className="row">
          <div className="col-lg-4 col-md-3 col-sm-10 col-xs-10 mb-2">
          ...
          <div className="col-lg-4 col-md-9 col-sm-8 col-xs-9 col-xl-8">
            <h2 className="mb-2">Products</h2>
            <div className="row">
              {filteredResults.map((product, i) => (
                <div
                  key={i}
                  className="col-lg-5 col-md-6 col-sm-12 col-xs-12 mb-3"
                >
